...
func (h *envoyBootstrapHook) servicePreflightCheck(
	...
	// TODO: can we get these from node meta?
	// preflightCheckTimeout := durationFromMeta(
	// 	h.node, "consul.service_preflight_check.timeout", time.Second*10)
	// preflightCheckBaseInterval := durationFromMeta(
	// 	h.node, "consul.service_preflight_check.base", time.Millisecond*500)
